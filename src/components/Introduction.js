...
const Introduction = async () => {
    ...
    return (
        <div className="relative 3xl:bg-cover bg-no-repeat grid grid-cols-2 pt-20" style={{
            ...
            <div className="relative">
                <Image src={rectangle27} className="absolute right-0 w-[70%] h-[40rem] 3xl:w-full 3xl:h-full" />
                <div className="absolute top-[5rem] 3xl:top-[13rem] 2xl:bg-cover right-[15%] 3xl:right-[10%] flex flex-col items-center">
