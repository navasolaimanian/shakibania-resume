...
const ImageIntroduction = () => {
    ...
    return (
        <div className="relative hidden md:block">
            <Image src={introductionRectangle2} className="absolute right-0 -top-4 lg:-top-2 xl:-top-20 h-[35rem] w-[90%] lg:w-[80%] xl:w-[70%] 2xl:w-[60%] 3xl:w-full xl:h-[40rem]  3xl:h-full" />
