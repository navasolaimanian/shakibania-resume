...
const DateText = (props) => {
    ...
    return (
        <div className="my-12 sm:pl-5 xl:pl-10 2xl:pl-14 pt-4 3:pt-10">
            {props.data.slice(0, 3).map(n =>
                <div className="text-gray-dark flex items-start">
                    <p className="text-xs sm:text-sm md:text-base min-w-[27%] lg:min-w-[10%] w-[19rem] sm:w-36 pt-2">{n.date}</p>
                    ...
                    <p className="text-sm xl:text-lg 3xl:text-xl min-w-[65%] sm:min-w-[60%]">{n.text}</p>
                </div>)}
