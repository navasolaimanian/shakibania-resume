...
const PublicationCart = (props) => {
  ...
  return (
    <div className="flex mb-8 w-[80%] bg-white p-6 rounded-lg">
      <Image src={props.publication.image} className="mr-12 w-72 h-44" alt="alt" width={100} height={100} />
      <div>
        <h1 className="text-xl text-[#7C7D81]">{props.publication.title}</h1>
