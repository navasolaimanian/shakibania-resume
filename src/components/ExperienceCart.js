...
const ExperienceCart = (props) => {
    ...
    return (
        <div className="relative bg-[#F3F6F9] hover:shadow-4xl cursor-pointer mb-8 md:mb-11 w-[90%] lg:w-[70%] xl:w-[75%] 2xl:w-[65%] p-5 lg:p-4 rounded-lg lg:transition lg:ease-in-out lg:delay-150 lg:hover:-translate-y-1 lg:hover:scale-[1.01]">
            <div className="flex">
